...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <div class="data svelte-tn9zuh"><h1 class="svelte-tn9zuh"><u>${escape(planet_name)}</u></h1> <label><b data-svelte-h="svelte-3fum2m">Planet Mass (m):</b>          
    ...
    m
    <input type="range" min="100" max="1000" step="1" class="svelte-tn9zuh"${add_attribute("value", planets[0].orbit, 0)}></label> <label><b data-svelte-h="svelte-9pgyyl">Radius of Planet (r<sub>p</sub>):</b>     
